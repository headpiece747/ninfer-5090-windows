...
### Vision Model with DFlash2 Speculative Decoding (131k Context Profile)
If your model artifact includes DFlash2 companion weights and you need image/video input, run `start_ninfer_dflash2_vision.bat`:
```cmd
build\apps\ninfer-serve.exe qwen3_8_27b_nvfp4.ninfer ^
  --vision ^
  --host 127.0.0.1 ^
