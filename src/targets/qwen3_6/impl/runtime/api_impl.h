...
template <>
SequencePlanner<Variant>::SequencePlanner(SequencePlanner&& other) noexcept : impl_(std::move(other.impl_)) {}
template <>
...
template <>
PressurePlanningSession<Variant>& PressurePlanningSession<Variant>::operator=(PressurePlanningSession&& other) noexcept {
    impl_ = std::move(other.impl_);
    return *this;
}
